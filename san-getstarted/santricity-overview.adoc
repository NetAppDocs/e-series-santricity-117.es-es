...
* System Manager de SANtricity: Una interfaz web que se utiliza para gestionar una controladora en una cabina de almacenamiento.
* Unified Manager de SANtricity: Una interfaz web que se utiliza para ver y gestionar todas las cabinas de almacenamiento en la red.

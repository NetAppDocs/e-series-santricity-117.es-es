...
[role="lead"]
Si se produce un error en una unidad o si desea reemplazarla por algún otro motivo, es posible reemplazar lógicamente la unidad con error por una unidad sin asignar o una pieza de repuesto totalmente integrada.

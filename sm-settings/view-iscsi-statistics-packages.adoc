...
RXP
 a| 
Número de paquetes recibidos. Seleccione *Mostrar IPv4* para mostrar el número de paquetes IPv4 recibidos. Seleccione *Mostrar IPv6* para mostrar el recuento de IPv6 paquetes recibidos.
